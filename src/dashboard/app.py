...
from src.dashboard.charity_commission_view import (
    render_charity_commission_page,
    render_official_register_preview,
)
...
def render_detail_panel(df: pd.DataFrame, selected_record_id: int | None = None) -> None:
    ...
    if isinstance(raw_record, dict):
        render_official_register_preview(raw_record)


def render_funder_discovery_page() -> None:
    render_intro()
...
def main() -> None:
    ...
    page = st.sidebar.radio(
        "View",
        ["Funder Discovery", "Official Register Data"],
        label_visibility="collapsed",
    )
    if page == "Official Register Data":
        render_charity_commission_page()
        return
    render_funder_discovery_page()
